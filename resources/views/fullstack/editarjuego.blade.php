...
<body>
    <nav class="navbar navbar-expand-lg bg-dark" data-bs-theme="dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">TechBoy</a>
    ...
    <div class="row">
        ...
        <div class="col-8" align="center">
            <h1>Modifica el juego</h1>
            <div class="alert alert-warning" role="alert" align="center">
                No es obligatorio cambiar todos los datos  
            </div>
            <form method="POST">
              @csrf
              <div class="mb"><br>
              ...
              <div class="mb"><br>
                <label for="costo" class="form-label">Nuevo costo del Videojuego</label>
                <input type="number" name="costo" id="costo" class="form-control" step="any" value="{{$juego->costo}}">
                @error('costo')
                  <small style="color:red">{{ $message }}</small>
                @enderror
              </div>
              <div class="mb"><br>
                ...
                <input type="number" name="jugadores" id="jugadores" class="form-control" step="1" value="{{$juego->jugadores}}">
                @error('jugadores')
                  <small style="color:red">{{ $message }}</small>
                @enderror
              </div>
              <div class="mb"><br>
                ...
                <input type="text" name="clasificacion" id="clasificacion" class="form-control" value="{{$juego->clasificacion}}">
                @error('clasificacion')
                  <small style="color:red">{{ $message }}</small>
                @enderror
              </div><br>
              <div class="mb">
                ...
                <input type="text" class="form-control" name="codigo" id="codigo" value="{{$juego->codigo}}">
                @error('codigo')
                    <small style="color:red">{{ $message }}</small>
                @enderror
